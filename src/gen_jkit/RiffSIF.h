...
public:
	...
	BOOL SetField(char id1,char id2,char id3,char id4,const _TCHAR *szData);
	...
	DWORD Load(const _TCHAR *szFileName,char id1,char id2,char id3,char id4);
	DWORD Save(HWND hWnd,const _TCHAR *szFileName);
